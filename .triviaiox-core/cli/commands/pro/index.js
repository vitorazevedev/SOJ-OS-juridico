 ...
 * Pro Command Module
 *
 * CLI commands for TRIVIAIOX Pro license management and feature gating.
 *
 * Subcommands:
 *   triviaiox pro activate --key <KEY>    Activate a license key
 *   triviaiox pro status                   Show license status
 *   triviaiox pro deactivate               Deactivate the current license
 *   triviaiox pro features                 List all pro features
 *   triviaiox pro validate                 Force online revalidation
 *   triviaiox pro setup                    Configure GitHub Packages access (AC-12)
 *
  ...
  if (options.verify) {
    ...
    try {
      ...
      if (deps['@triviaiox-fullstack/pro']) {
        console.log(`✅ @triviaiox-fullstack/pro@${deps['@triviaiox-fullstack/pro'].version} is installed`);
      } else {
...
function createProCommand() {
  const proCmd = new Command('pro')
    .description('TRIVIAIOX Pro license management');
