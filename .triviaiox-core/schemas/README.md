# TRIVIAIOX V3 Schemas

> Schema definitions for TRIVIAIOX agents and tasks with Auto-Claude capabilities.
...
- **V2 (Legacy)**: Current TRIVIAIOX format without `autoClaude` section
...
```bash
node validate-v3-schema.js .triviaiox-core/development/agents/dev.md
```
...
```bash
node validate-v3-schema.js --diff .triviaiox-core/development/agents/dev.md
```
...
```bash
node validate-v3-schema.js .triviaiox-core/development/agents/dev.md --strict
```
...
- PRD: `docs/prd/triviaiox-autonomous-development-engine.md`
- Auto-Claude Analysis: `docs/architecture/AUTO-CLAUDE-ANALYSIS-COMPLETE.md`
- Migration Stories: `docs/stories/triviaiox-core-ade/epic-2-migration-v2-v3.md`
...
_TRIVIAIOX V3 Schemas - TriviaGrowth Framework_
