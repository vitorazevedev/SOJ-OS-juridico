...
> Each variable is replaced at runtime by the orchestrator (triviaiox-master) before spawning the subagent via the Task tool.
...
|---------|-----------|-----------|-----------|
| `core` | `.triviaiox-core/development/agents/{agent}.md` | `.triviaiox-core/development/tasks/{uses}.md` | `.triviaiox-core/data/{file}` |
...
2. If not found, check `.triviaiox-core/development/agents/{agent}.md`
...
- The orchestrator (triviaiox-master) builds the prompt by reading files and replacing variables
