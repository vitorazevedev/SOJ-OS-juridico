# TRIVIAIOX Documentation Template
...
This document provides the standard template structure for TRIVIAIOX documentation. All documentation in the TRIVIAIOX framework should follow this template to ensure consistency and ease of navigation.
...
_Last Updated: {{DATE}} | TRIVIAIOX Framework Team_
```
...
Brief description of what this document covers and its purpose within the TRIVIAIOX framework.
...
**Version:** 1.0.0
**Last Updated:** 2026-01-28
**Audience:** Developers extending TRIVIAIOX

---

## Overview

This guide explains how to create custom agents for the TRIVIAIOX framework.

## Prerequisites

- [ ] TRIVIAIOX Core installed
...
Create a new file in `.triviaiox-core/development/agents/`:
...
- [TRIVIAIOX Framework Documentation](/docs/README.md)
