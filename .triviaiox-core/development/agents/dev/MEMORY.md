...
### Project Structure
- `.triviaiox-core/core/` — Core modules (synapse, session, code-intel, orchestration)
- `.triviaiox-core/development/` — Agents, tasks, templates, scripts
- `.triviaiox-core/infrastructure/` — CI/CD, git detection, project-status
...
- atomicWriteSync from `.triviaiox-core/core/synapse/utils/atomic-write` for safe file writes
