...
```javascript
const { generateStoryIndex } = require('.triviaiox-core/scripts/story-index-generator');
...
Stories by Epic:
- Epic 6.1 TRIVIAIOX Migration: 45 stories
...
{
  "scripts": {
    "stories:index": "node .triviaiox-core/scripts/story-index-generator.js docs/stories"
  }
}
```
