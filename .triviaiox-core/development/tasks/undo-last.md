...
- **Tool:** backup-manager
  ...
  - **Source:** .triviaiox-core/utils/backup-manager.js
...
- **Script:** rollback-changes.js
  ...
  - **Language:** JavaScript
  - **Location:** .triviaiox-core/scripts/rollback-changes.js
...
Rollback the last component creation or modification operation. This task allows undoing recent changes made by the triviaiox-developer agent, including single component creation, batch creation, or component updates.
...
Operations:
  - Created: /triviaiox-core/agents/data-analyst.md
  - Updated: /triviaiox-core/team-manifest.yaml
  - Created: /triviaiox-core/tasks/analyze-data.md
```
