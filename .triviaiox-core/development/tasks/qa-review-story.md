...
2. Call `getReferenceImpact(files)` from `.triviaiox-core/core/code-intel/helpers/qa-helper.js`
...
- Create directory defined in `qa.qaLocation/gates` (see `.triviaiox-core/core-config.yaml`) if missing
