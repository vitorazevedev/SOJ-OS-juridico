...
pre-conditions:
  ...
  - [ ] Brownfield Analyzer module is available
    ...
    blocker: true
    validation: |
      Verify .triviaiox-core/infrastructure/scripts/documentation-integrity/brownfield-analyzer.js exists
...
- **Tool:** brownfield-analyzer
  ...
  - **Source:** .triviaiox-core/infrastructure/scripts/documentation-integrity/brownfield-analyzer.js

- **Tool:** mode-detector
  - **Purpose:** Collect project markers for analysis
  - **Source:** .triviaiox-core/infrastructure/scripts/documentation-integrity/mode-detector.js
...
- **Script:** brownfield-analyzer.js
  ...
  - **Language:** JavaScript
  - **Location:** .triviaiox-core/infrastructure/scripts/documentation-integrity/brownfield-analyzer.js
...
Analyze an existing project to understand its structure, tech stack, coding standards, and CI/CD workflows before TRIVIAIOX integration. This task provides recommendations for safe integration and identifies potential conflicts.
...
```javascript
const { analyzeProject, formatMigrationReport } = require('./.triviaiox-core/infrastructure/scripts/documentation-integrity/brownfield-analyzer');
...
╠══════════════════════════════════════════════════════════════════════╣
║                                                                      ║
║  • Preserve existing ESLint configuration - TRIVIAIOX will adapt          ║
║  • Keep existing Prettier settings - TRIVIAIOX coding-standards.md will d ║
║  • Review existing CI/CD before adding TRIVIAIOX workflows                ║
║  • TRIVIAIOX will use existing tsconfig.json settings                     ║
...
|----------|---------|---------|
| `parallel` | Safe to proceed with standard TRIVIAIOX setup | Use `*setup-project-docs` directly |
...
1. **Review GitHub Workflows:**
   ...
   # Check for potential conflicts with TRIVIAIOX workflows
...
1. **docs/architecture/ exists:**
   - Decide: Keep existing or merge with TRIVIAIOX docs
   - Option A: Rename existing to `docs/legacy-architecture/`
   - Option B: Configure TRIVIAIOX to use alternate path
...
- Run this task BEFORE any TRIVIAIOX integration
