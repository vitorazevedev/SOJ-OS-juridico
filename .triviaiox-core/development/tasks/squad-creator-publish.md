...
Publishes a local squad to the triviaiox-squads GitHub repository via Pull Request.
...
PR Preview:
  ...
  Target: Trivia-Growth/triviaiox-squads
...
Publishing: my-squad@1.0.0
  ...
  Target: github.com/Trivia-Growth/triviaiox-squads
...
Pull Request Created!
  URL: https://github.com/Trivia-Growth/triviaiox-squads/pull/42
  Branch: squad/my-squad
...
4. Create/check fork
   └── Fork Trivia-Growth/triviaiox-squads if needed
...
- `.triviaiox-core/development/scripts/squad/squad-publisher.js`
