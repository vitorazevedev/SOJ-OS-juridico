...
autoClaude:
  ...
  verification:
    type: script
    script: .triviaiox-core/infrastructure/scripts/subtask-verifier.js
    timeout: 120
```
  ...
  actions:
    - action: find_implementation
      paths:
        ...
        - .triviaiox/plans/{storyId}/implementation.yaml
...
step_2:
  actions:
    - action: execute_script
      script: |
        node .triviaiox-core/infrastructure/scripts/subtask-verifier.js {subtaskId} \
