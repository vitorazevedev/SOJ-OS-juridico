...
pre-conditions:
  ...
  - [ ] Pattern storage exists
    tipo: pre-condition
    blocker: false
    validação: Check .triviaiox-core/data/learned-patterns.yaml exists
...
```javascript
const learning = require('.triviaiox-core/workflow-intelligence/learning');
...
Storage file: .triviaiox-core/data/learned-patterns.yaml
...
try {
  ...
  console.log('Try running: rm .triviaiox-core/data/learned-patterns.yaml');
}
```
