...
required:
  ...
  - story_path: `triviaiox-core/core-config.yaml` for the `devStoryLocation`

optional:
  - architecture_refs: `triviaiox-core/core-config.yaml` for the `architecture.architectureFile`
  - technical_preferences: `triviaiox-core/core-config.yaml` for the `technicalPreferences`
