...
```bash
node bin/triviaiox-ids.js ids:check "your intent" --type task
node bin/triviaiox-ids.js ids:impact create-doc
node bin/triviaiox-ids.js ids:stats --json
node bin/triviaiox-ids.js ids:register path/to/file.md
```
...
- `.triviaiox-core/core/ids/framework-governor.js` — FrameworkGovernor class
- `.triviaiox-core/core/ids/registry-loader.js` — RegistryLoader
- `.triviaiox-core/core/ids/incremental-decision-engine.js` — DecisionEngine
- `.triviaiox-core/core/ids/registry-updater.js` — RegistryUpdater
- `.triviaiox-core/core/ids/registry-healer.js` — RegistryHealer (optional, IDS-4a)
