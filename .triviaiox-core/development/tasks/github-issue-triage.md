...
Systematic triage of GitHub issues for the triviaiox-core repository. This task guides @devops through the process of reviewing, classifying, and labeling open issues.
...
```bash
node .triviaiox-core/development/scripts/issue-triage.js --list
node .triviaiox-core/development/scripts/issue-triage.js --apply {number} --type bug --priority P2 --area installer
```
...
```bash
node .triviaiox-core/development/scripts/issue-triage.js --report
```
