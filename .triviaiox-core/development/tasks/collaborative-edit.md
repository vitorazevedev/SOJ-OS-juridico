...
# Collaborative Edit - TRIVIAIOX Developer Task
...
*collaborative-edit start --component triviaiox-core/agents/data-agent.md --participants alice,bob --mode live
...
class CollaborativeEditTask extends EventEmitter {
  constructor() {
    ...
    this.sessionDir = path.join(this.rootPath, '.triviaiox', 'sessions');
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('👥 TRIVIAIOX Collaborative Editing'));
