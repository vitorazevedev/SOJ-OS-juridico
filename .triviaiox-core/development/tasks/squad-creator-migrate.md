...
Migrates legacy squad formats to TRIVIAIOX 2.1 standard.
...
| Missing `triviaiox.type` | Field not present | Add `triviaiox.type: squad` |
| Missing `triviaiox.minVersion` | Field not present | Add `triviaiox.minVersion: 2.1.0` |
...
───────────────────────────────────────────────────────────
  ...
  ❌ [ERROR] Missing required field: triviaiox.type
  ❌ [ERROR] Missing required field: triviaiox.minVersion
...
───────────────────────────────────────────────────────────
  ...
  3. Add field: triviaiox.type = "squad"
  4. Add field: triviaiox.minVersion = "2.1.0"
...
───────────────────────────────────────────────────────────
  ...
  Executed Actions:
    ...
    ✅ Add field: triviaiox.type = "squad" [success]
    ✅ Add field: triviaiox.minVersion = "2.1.0" [success]
...
───────────────────────────────────────────────────────────
  ...
  Executed Actions:
    ...
    🔍 Add field: triviaiox.type = "squad" [dry-run]
    🔍 Add field: triviaiox.minVersion = "2.1.0" [dry-run]
...
```javascript
const { SquadMigrator } = require('./.triviaiox-core/development/scripts/squad');
const { SquadValidator } = require('./.triviaiox-core/development/scripts/squad');
...
- **Schema:** .triviaiox-core/schemas/squad-schema.json
