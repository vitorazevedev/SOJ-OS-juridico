...
const { getCodebaseOverview, getDependencyGraph } = require('.triviaiox-core/core/code-intel/helpers/planning-helper');
...
```javascript
// .triviaiox-core/core/orchestration/executor-assignment.js
const { assignExecutorFromContent } = require('.triviaiox-core/core/orchestration/executor-assignment');
