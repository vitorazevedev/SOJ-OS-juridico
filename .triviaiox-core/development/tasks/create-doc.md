...
# User selects from available templates in .triviaiox-core/product/templates/
tools:
...
If a YAML Template has not been provided, list all templates from .triviaiox-core/product/templates or ask the user to provide another.
