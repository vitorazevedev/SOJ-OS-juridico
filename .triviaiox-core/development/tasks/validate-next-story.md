...
- Load `.triviaiox-core/core-config.yaml`
...
- Identify and load the following inputs:
  ...
  - **Story template**: `triviaiox-core/templates/story-tmpl.yaml` for completeness validation

### 1. Template Completeness Validation

- Load `triviaiox-core/templates/story-tmpl.yaml` and extract all section headings from the template
...
- **If available:**
  - Call `validateNoDuplicates(storyDescription)` from `.triviaiox-core/core/code-intel/helpers/story-helper`
