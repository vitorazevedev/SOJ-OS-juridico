...
- **Script:** parse-qa-report.js
  ...
  - **Language:** JavaScript
  - **Location:** .triviaiox-core/development/scripts/parse-qa-report.js (optional)
...
_Generated by Quinn (Test Architect) - TRIVIAIOX QA System_
...
**Location:** `.triviaiox-core/development/tasks/qa-review-story.md`
