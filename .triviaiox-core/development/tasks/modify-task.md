...
- Target task must exist in `triviaiox-core/tasks/`
...
- Load target task from `triviaiox-core/tasks/{task-name}.md`
- Create timestamped backup: `triviaiox-core/tasks/.backups/{task-name}.md.{timestamp}`
