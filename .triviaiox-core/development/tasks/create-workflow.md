...
## Purpose
To create a new workflow definition that orchestrates multiple agents and tasks for complex multi-step processes in TriviaGrowth Triviaiox.
...
4. **Create Workflow File**
   - Resolve output path based on target_context:
     - `core` → `.triviaiox-core/development/workflows/{workflow-name}.yaml`
