...
Downloads public squads from the triviaiox-squads GitHub repository to use in your project.
...
Available Squads (from triviaiox-squads):
...
Downloading: etl-squad@1.0.0
  Source: github.com/Trivia-Growth/triviaiox-squads/packages/etl-squad
...
```
1. Fetch registry.json from triviaiox-squads
...
The registry.json in triviaiox-squads contains:
...
- `.triviaiox-core/development/scripts/squad/squad-downloader.js`
