...
Each component type uses a template from `.triviaiox-core/development/templates/squad/`:
...
- **Scripts:**
  - `.triviaiox-core/development/scripts/squad/squad-loader.js`
  - `.triviaiox-core/development/scripts/squad/squad-extender.js`
  - `.triviaiox-core/development/scripts/squad/squad-validator.js`

- **Templates:**
  - `.triviaiox-core/development/templates/squad/agent-template.md`
  - `.triviaiox-core/development/templates/squad/task-template.md`
  - `.triviaiox-core/development/templates/squad/workflow-template.md`
  - `.triviaiox-core/development/templates/squad/checklist-template.md`
  - `.triviaiox-core/development/templates/squad/template-template.md`
  - `.triviaiox-core/development/templates/squad/tool-template.js`
  - `.triviaiox-core/development/templates/squad/script-template.js`
  - `.triviaiox-core/development/templates/squad/data-template.yaml`
