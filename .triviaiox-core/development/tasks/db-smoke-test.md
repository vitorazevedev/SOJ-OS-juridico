...
- **Tool:** query-validator
  ...
  - **Source:** .triviaiox-core/utils/db-query-validator.js
...
- **Script:** db-query.js
  ...
  - **Language:** JavaScript
  - **Location:** .triviaiox-core/scripts/db-query.js
...
3. `.triviaiox-core/product/templates/tmpl-smoke-test.sql` (template)
...
elif [ -f ".triviaiox-core/product/templates/tmpl-smoke-test.sql" ]; then
  SMOKE_TEST=".triviaiox-core/product/templates/tmpl-smoke-test.sql"
else
