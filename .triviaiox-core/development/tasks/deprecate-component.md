...
# Deprecate Component - TRIVIAIOX Developer Task
...
*deprecate-component util old-logger --replacement @triviaiox/logger --migration-guide docs/migration/logger.md --severity high
...
class DeprecateComponentTask {
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('🚫 TRIVIAIOX Component Deprecation'));
