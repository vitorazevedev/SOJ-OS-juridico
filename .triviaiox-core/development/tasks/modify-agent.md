...
- Target agent must exist in `triviaiox-core/agents/`
...
- Load target agent from `triviaiox-core/agents/{agent-name}.md`
- Parse YAML header and markdown content separately
- Create timestamped backup: `triviaiox-core/agents/.backups/{agent-name}.md.{timestamp}`
