...
Lists all TRIVIAIOX-managed worktrees with their current status, uncommitted changes, and age. Provides visibility into parallel development activities.

**Features:**

- Shows all active worktrees managed by TRIVIAIOX
...
**Action:** Get all TRIVIAIOX-managed worktrees
...
[
  {
    "storyId": "STORY-42",
    "path": "/abs/path/.triviaiox/worktrees/STORY-42",
...
No TRIVIAIOX-managed worktrees found.
...
**Resolution:** Check TRIVIAIOX installation.
