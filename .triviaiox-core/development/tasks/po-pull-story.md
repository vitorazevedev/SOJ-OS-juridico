...
```javascript
const { getPMAdapter, isPMToolConfigured } = require('../.triviaiox-core/scripts/pm-adapter-factory');
...
```javascript
const { pullStoryFromPM } = require('../.triviaiox-core/scripts/story-manager');
