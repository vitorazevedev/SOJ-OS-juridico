...
**Quality Standard:** TRIVIAIOX Level (300+ lines, voice_dna, output_examples, command_loader, task files)
...
generate_agent:
  ...
  required_sections:
    # Level 1: Identity
    activation_notice: 'Standard TRIVIAIOX header'
...
## Integration with TRIVIAIOX

This task creates agents that:

- Follow TRIVIAIOX agent definition standards (6 levels)
