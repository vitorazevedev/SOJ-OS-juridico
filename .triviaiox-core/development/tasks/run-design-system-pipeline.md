...
- **Tool:** build-component
  ...
  - **Source:** .triviaiox-core/development/tasks/build-component.md

- **Tool:** generate-documentation
  - **Purpose:** Generate Pattern Library docs
  - **Source:** .triviaiox-core/development/tasks/generate-documentation.md
...
- **Tool:** calculate-roi
  ...
  - **Source:** .triviaiox-core/development/tasks/calculate-roi.md
  ...
  quality-pipeline:
    ...
    steps:
      ...
      - name: Run Design System Pipeline
        run: npx triviaiox-core task run-design-system-pipeline --mode=yolo
```
...
{
  "scripts": {
    "ds:pipeline": "npx triviaiox-core task run-design-system-pipeline",
    "ds:pipeline:ci": "npx triviaiox-core task run-design-system-pipeline --mode=yolo"
  }
}
```
