...
**Updated:** 2025-12-14
**Agent:** @dev (Dex)
**Location:** .triviaiox-core/development/tasks/setup-llm-routing.md
...
```bash
node .triviaiox-core/infrastructure/scripts/llm-routing/install-llm-routing.js
```
...
- Tool Definition: `.triviaiox-core/infrastructure/tools/cli/llm-routing.yaml`
- Install Script: `.triviaiox-core/infrastructure/scripts/llm-routing/install-llm-routing.js`
