...
- field: core_config
  type: file
  destination: .triviaiox-core/core-config.yaml
  persisted: true
...
pre-conditions:
  ...
  - [ ] Documentation Integrity module is available
    ...
    blocker: true
    validation: |
      Verify .triviaiox-core/infrastructure/scripts/documentation-integrity/index.js exists
...
post-conditions:
  ...
  - [ ] core-config.yaml created with valid deployment section
    ...
    blocker: true
    validation: |
      Verify .triviaiox-core/core-config.yaml exists and has deployment configuration
...
acceptance-criteria:
  ...
  - [ ] .gitignore properly configured for project
    ...
    blocker: true
    validation: |
      Assert .gitignore includes TRIVIAIOX ignores and tech stack ignores
...
- **Tool:** documentation-integrity
  ...
  - **Source:** .triviaiox-core/infrastructure/scripts/documentation-integrity/index.js

- **Tool:** deployment-config-loader
  - **Purpose:** Load and validate deployment configuration
  - **Source:** .triviaiox-core/infrastructure/scripts/documentation-integrity/deployment-config-loader.js
...
- **Script:** mode-detector.js
  ...
  - **Language:** JavaScript
  - **Location:** .triviaiox-core/infrastructure/scripts/documentation-integrity/mode-detector.js

- **Script:** doc-generator.js
  - **Purpose:** Generate project documentation from templates
  - **Language:** JavaScript
  - **Location:** .triviaiox-core/infrastructure/scripts/documentation-integrity/doc-generator.js

- **Script:** config-generator.js
  - **Purpose:** Generate core-config.yaml
  - **Language:** JavaScript
  - **Location:** .triviaiox-core/infrastructure/scripts/documentation-integrity/config-generator.js

- **Script:** gitignore-generator.js
  - **Purpose:** Generate or merge .gitignore
  - **Language:** JavaScript
  - **Location:** .triviaiox-core/infrastructure/scripts/documentation-integrity/gitignore-generator.js
...
```javascript
const { detectInstallationMode, collectMarkers } = require('./.triviaiox-core/infrastructure/scripts/documentation-integrity');
...
|------|-------------|---------|
| `framework-dev` | Contributing to triviaiox-core itself | Skip project setup, use existing config |
...
```javascript
const { buildDocContext, generateDocs } = require('./.triviaiox-core/infrastructure/scripts/documentation-integrity');
...
```javascript
const { buildConfigContext, generateConfig, DeploymentWorkflow, DeploymentPlatform } = require('./.triviaiox-core/infrastructure/scripts/documentation-integrity');
...
```javascript
const { generateGitignoreFile, hasTriviaioxIntegration } = require('./.triviaiox-core/infrastructure/scripts/documentation-integrity');
...
```javascript
const { loadDeploymentConfig, validateDeploymentConfig } = require('./.triviaiox-core/infrastructure/scripts/documentation-integrity');
...
Generated Files:
  ...
  ✓ .triviaiox-core/core-config.yaml
  ✓ .gitignore (created)
