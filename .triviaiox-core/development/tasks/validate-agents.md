...
Scan `.triviaiox-core/development/agents/` for all `.md` files.
Expected agents: dev, qa, architect, pm, po, sm, analyst, data-engineer, ux-design-expert, devops, triviaiox-master, squad-creator
...
1. Check that each referenced task file exists in `.triviaiox-core/development/tasks/`
2. Report missing dependencies as ERRORS

For each agent's `dependencies.checklists` list:
1. Check in `.triviaiox-core/development/checklists/`
...
- Agent files in `.triviaiox-core/development/agents/`
- Task files in `.triviaiox-core/development/tasks/`
