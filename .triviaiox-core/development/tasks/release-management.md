...
- **published_packages**: `array<object>`
  ...
  - **Example**: `[{ registry: "npm", package_name: "triviaiox-core", version: "2.1.3", url: "https://npmjs.com/package/triviaiox-core" }]`
...
triviaiox release create --repo="." --type="auto"
````
