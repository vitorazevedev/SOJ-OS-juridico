...
atomic_layer: task
Entrada: |
  - preset_path: Path to the tech preset file (default: .triviaiox-core/data/tech-presets/)
...
1. Resolve preset path
   ...
   ├── If name provided → resolve via .triviaiox-core/data/tech-presets/{name}.md
...
- Preset: .triviaiox-core/data/tech-presets/{name}.md
```

## Related

- **Agent:** @architect (Aria)
- **Location:** .triviaiox-core/data/tech-presets/
