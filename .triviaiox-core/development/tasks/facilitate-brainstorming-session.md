...
- **topic**: `string`
  ...
  - **Example**: "How can we improve user onboarding for TRIVIAIOX?"
...
```bash
triviaiox activate Maestro
triviaiox brainstorm "How can we improve TRIVIAIOX user onboarding for non-technical users?"
```
...
```bash
triviaiox brainstorm "How to reduce API latency in database queries?" \
...
```bash
triviaiox brainstorm "What should be our open-source expansion strategy for Q1 2026?" \
