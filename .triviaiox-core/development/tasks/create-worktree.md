...
pre-conditions:
  ...
  - [ ] WorktreeManager is available
    tipo: pre-condition
    blocker: true
    validação: Script exists at .triviaiox-core/infrastructure/scripts/worktree-manager.js
    error_message: "WorktreeManager not found. Ensure TRIVIAIOX is properly installed."
...
post-conditions:
  - [ ] Worktree directory exists
    tipo: post-condition
    blocker: true
    validação: Directory exists at .triviaiox/worktrees/{storyId}
...
- **Tool:** WorktreeManager
  ...
  - **Source:** .triviaiox-core/infrastructure/scripts/worktree-manager.js
...
```javascript
const WorktreeManager = require('./.triviaiox-core/infrastructure/scripts/worktree-manager.js');
...
⚠️  Worktree for '{storyId}' already exists.
    Path: .triviaiox/worktrees/{storyId}
...
- Directory: `.triviaiox/worktrees/{storyId}/`
- Branch: `auto-claude/{storyId}`
...
Next Steps:
  • cd .triviaiox/worktrees/{storyId}  - Navigate to worktree
...
interface WorktreeInfo {
  ...
  path: string; // '/abs/path/.triviaiox/worktrees/STORY-42'
...
- `.triviaiox/worktrees/{storyId}/` - Isolated worktree directory
...
```bash
git worktree remove .triviaiox/worktrees/{storyId}
...
- `.triviaiox-core/infrastructure/scripts/worktree-manager.js` - Core manager
...
- **Script:** `.triviaiox-core/infrastructure/scripts/worktree-manager.js`
