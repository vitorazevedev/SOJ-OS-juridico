...
const overview = {
  ...
  triviaioxMinVersion: manifest.triviaiox?.minVersion || 'N/A',
...
Overview
  ...
  Author: {author}
  License: {license}
  TRIVIAIOX Min Version: {triviaioxMinVersion}
...
- **Scripts:**
  ...
  - `.triviaiox-core/development/scripts/squad/squad-analyzer.js`
