...
- **Tool:** ast-parser
  ...
  - **Source:** .triviaiox-core/utils/ast-parser.js
...
- **Script:** modify-file.js
  ...
  - **Language:** JavaScript
  - **Location:** .triviaiox-core/scripts/modify-file.js
...
- Target workflow must exist (path resolved from target_context):
  - `core` → `.triviaiox-core/development/workflows/`
...
- Create timestamped backup in same context:
  - `core` → `.triviaiox-core/development/workflows/.backups/{workflow-name}.yaml.{timestamp}`
...
+ modified_by: triviaiox-developer
