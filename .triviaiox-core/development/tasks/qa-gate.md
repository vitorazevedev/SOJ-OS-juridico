...
**ALWAYS** check the `triviaiox-core/core-config.yaml` for the `qa.qaLocation/gates`
...
2. Call `getBlastRadius(files)` from `.triviaiox-core/core/code-intel/helpers/qa-helper.js`
...
1. **ALWAYS** create gate file at: `qa.qaLocation/gates` from `triviaiox-core/core-config.yaml`
