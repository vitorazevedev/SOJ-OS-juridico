...
This directory contains workflow definitions for the TriviaGrowth Triviaiox framework. Workflows define multi-step processes that can be executed by TRIVIAIOX agents.
...
The `setup-environment` workflow helps developers configure their IDE for optimal TRIVIAIOX development experience.

### Features
- Backs up existing IDE configurations
- Applies TRIVIAIOX-specific development rules
- Verifies GitHub CLI installation and authentication
- Provides clear feedback throughout the process

### Usage

From the triviaiox-master agent:
```
@triviaiox-master
*setup-environment
```
...
4. **Rule Application** - Copies TRIVIAIOX-specific rules to appropriate locations
