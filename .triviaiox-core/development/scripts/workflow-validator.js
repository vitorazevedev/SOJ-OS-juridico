 ...
 * Workflow Validator
 *
 * Validates workflow YAML files against TRIVIAIOX workflow conventions:
 * 1. YAML syntax
...
class WorkflowValidator {
  ...
  constructor(options = {}) {
    ...
    this.agentsPath = options.agentsPath || path.join(process.cwd(), '.triviaiox-core', 'development', 'agents');
