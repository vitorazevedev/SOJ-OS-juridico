...
const SCAN_CONFIG = [
  { category: 'tasks', basePath: '.triviaiox-core/development/tasks', glob: '**/*.md', type: 'task' },
  { category: 'templates', basePath: '.triviaiox-core/product/templates', glob: '**/*.{yaml,yml,md}', type: 'template' },
  { category: 'scripts', basePath: '.triviaiox-core/development/scripts', glob: '**/*.{js,mjs}', type: 'script' },
  { category: 'modules', basePath: '.triviaiox-core/core', glob: '**/*.{js,mjs}', type: 'module' },
  { category: 'agents', basePath: '.triviaiox-core/development/agents', glob: '**/*.{md,yaml,yml}', type: 'agent' },
  { category: 'checklists', basePath: '.triviaiox-core/development/checklists', glob: '**/*.md', type: 'checklist' },
  { category: 'data', basePath: '.triviaiox-core/data', glob: '**/*.{yaml,yml,md}', type: 'data' },
  { category: 'workflows', basePath: '.triviaiox-core/development/workflows', glob: '**/*.{yaml,yml}', type: 'workflow' },
  { category: 'utils', basePath: '.triviaiox-core/core/utils', glob: '**/*.js', type: 'util' },
  { category: 'tools', basePath: '.triviaiox-core/development/tools', glob: '**/*.{md,js,sh}', type: 'tool' },
  { category: 'infra-scripts', basePath: '.triviaiox-core/infrastructure/scripts', glob: '**/*.js', type: 'script' },
  { category: 'infra-tools', basePath: '.triviaiox-core/infrastructure/tools', glob: '**/*.{yaml,yml,md}', type: 'tool' },
  { category: 'product-checklists', basePath: '.triviaiox-core/product/checklists', glob: '**/*.md', type: 'checklist' },
  { category: 'product-data', basePath: '.triviaiox-core/product/data', glob: '**/*.{yaml,yml,md}', type: 'data' }
];
...
const KNOWN_AGENTS = [
  ...
  'analyst', 'data-engineer', 'ux-design-expert', 'triviaiox-master'
];
...
function populate(options = {}) {
  const verbose = options.verbose || process.argv.includes('--verbose') || process.env.TRIVIAIOX_DEBUG === 'true';
