 ...
 * New code should use: .triviaiox-core/core/orchestration/session-state.js
 *
 ...
 *
 * State files are stored at: .triviaiox/{instance-id}-state.yaml
 *
 * Design constraints:
...
class WorkflowStateManager {
  ...
  constructor(options = {}) {
    ...
    this.stateDir = path.join(this.basePath, '.triviaiox');
  }
  ...
  resolveAgentPaths(state) {
    const corePath = path.join(this.basePath, '.triviaiox-core', 'development', 'agents');
