...
/**
 * Git operations wrapper for TRIVIAIOX framework modifications
 */
class GitWrapper {
  constructor(options = {}) {
  ...
  async commit(message, options = {}) {
    const {
      author = 'triviaiox-developer <triviaiox-developer@triviaiox-fullstack.local>',
      signoff = true
    } = options;
  ...
  async commitModification(files, message, metadata = {}) {
    ...
    fullMessage += '\n\nGenerated by: triviaiox-developer meta-agent';
