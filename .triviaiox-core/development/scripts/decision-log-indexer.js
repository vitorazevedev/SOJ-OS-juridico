 ...
 * @see .triviaiox-core/scripts/decision-recorder.js
 */
...
async function loadConfig() {
  ...
  try {
    const configContent = await fs.readFile('.triviaiox-core/core-config.yaml', 'utf8');
...
- [Core Configuration](.triviaiox-core/core-config.yaml)
...
*To manually rebuild the index, run: node .triviaiox-core/scripts/decision-log-indexer.js rebuild*
`;
