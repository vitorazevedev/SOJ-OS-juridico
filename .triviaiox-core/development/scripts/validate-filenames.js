 ...
 *
 * Usage:
 *   node .triviaiox-core/utils/validate-filenames.js
 *   node .triviaiox-core/utils/validate-filenames.js --fix
 */
...
class FilenameValidator {
  ...
  report() {
    console.log('\n📋 TRIVIAIOX Filename Validation Report\n');
    ...
    if (this.errors.length > 0) {
      ...
      console.log('3. Or run: node .triviaiox-core/utils/validate-filenames.js --fix\n');
