/**
 * Story Index Generator for TRIVIAIOX Framework
 *
...
`;
  ...
  markdown += '\n---\n\n';
  markdown += '*Auto-generated by TRIVIAIOX Story Index Generator (Story 6.1.2.6)*\n';
  markdown += '*Update: Run `npm run stories:index` or `node .triviaiox-core/scripts/story-index-generator.js docs/stories`*\n';
