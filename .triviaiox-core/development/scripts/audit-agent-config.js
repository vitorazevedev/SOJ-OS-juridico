 ...
 *
 * Analyzes all 13 TRIVIAIOX agents to determine which core-config.yaml sections
...
async function extractAgentDependencies(agentId) {
  const agentPath = path.join('.triviaiox-core', 'agents', `${agentId}.md`);
...
function analyzeConfigNeeds(agentData) {
  ...
  if (agentData.agentId === 'triviaiox-master' ||
...
*Auto-generated by TRIVIAIOX Agent Config Audit (Story 6.1.2.6)*
`;
...
async function auditAllAgents() {
  console.log('🔍 Auditing all 13 TRIVIAIOX agents...\n');
