 ...
 *
 * Publishes squads to the triviaiox-squads GitHub repository via Pull Request.
...
/**
 * Repository for triviaiox-squads
 * @constant {string}
 */
const TRIVIAIOX_SQUADS_REPO = 'Trivia-Growth/triviaiox-squads';
...
/**
 * Squad Publisher class for publishing squads to triviaiox-squads repository
 */
class SquadPublisher {
   ...
   * @param {string} [options.repo] - Target repository (default: Trivia-Growth/triviaiox-squads)
   */
  constructor(options = {}) {
    this.verbose = options.verbose || false;
    this.dryRun = options.dryRun || false;
    this.repo = options.repo || TRIVIAIOX_SQUADS_REPO;
  }
  ...
  /**
   * Publish squad to triviaiox-squads repository
   *
...
- [x] Squad follows TRIVIAIOX task-first architecture
...
---
*Submitted via \`*publish-squad\` from TRIVIAIOX-FullStack*`;
  }
