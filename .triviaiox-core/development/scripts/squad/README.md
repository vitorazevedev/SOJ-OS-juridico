...
Utilities for the squad-creator agent to manage squads in TRIVIAIOX projects.
...
```javascript
const { SquadLoader } = require('./.triviaiox-core/development/scripts/squad');
...
```javascript
const { SquadLoader, SquadLoaderError } = require('./.triviaiox-core/development/scripts/squad');
...
# Run with coverage
npm test -- tests/unit/squad/squad-loader.test.js --coverage --collectCoverageFrom=".triviaiox-core/development/scripts/squad/*.js"
```
