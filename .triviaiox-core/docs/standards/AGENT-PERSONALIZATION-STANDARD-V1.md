...
│   (.triviaiox-core/agents/*.md)          │
└─────────────────────────────────────┘
              ↓
┌─────────────────────────────────────┐
│   LAYER 2: Output Formatter         │  ← Template engine (JS)
│   (.triviaiox-core/infrastructure/scripts/)│
└─────────────────────────────────────┘
              ↓
┌─────────────────────────────────────┐
...
```yaml
# .triviaiox-core/agents/{agent-id}.md
...
```yaml
# .triviaiox-core/data/archetype-vocabulary.yaml
...
```javascript
// .triviaiox-core/infrastructure/scripts/output-formatter.js
...
```javascript
// .triviaiox-core/infrastructure/scripts/validate-output-pattern.js
...
```markdown
<!-- .triviaiox-core/templates/task-execution-report.md -->
...
```markdown
<!-- .triviaiox-core/templates/agent-checklist-template.md -->
...
```yaml
# .triviaiox-core/workflows/{workflow-name}.yaml
...
11. Merge triviaiox-developer + triviaiox-orchestrator → triviaiox-master.md → Orion (Orchestrator)
