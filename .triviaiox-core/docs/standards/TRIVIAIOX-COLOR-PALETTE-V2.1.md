# TRIVIAIOX Color Palette v4.2

**Version:** 2.1.0  
**Created:** 2025-01-20  
**Status:** Active  
**Scope:** All TRIVIAIOX CLI tools, installer, and visual outputs
...
The TRIVIAIOX color palette is derived from the brand logo's vibrant gradient:
...
:root {
  /* Brand Colors */
  --triviaiox-primary: #8B5CF6;
  --triviaiox-secondary: #EC4899;
  --triviaiox-tertiary: #3B82F6;
  
  /* Functional Colors */
  --triviaiox-success: #10B981;
  --triviaiox-warning: #F59E0B;
  --triviaiox-error: #EF4444;
  --triviaiox-info: #06B6D4;
  
  /* Neutral Colors */
  --triviaiox-muted: #94A3B8;
  --triviaiox-dim: #64748B;
  
  /* Gradient */
  --triviaiox-gradient: linear-gradient(135deg, #EC4899 0%, #8B5CF6 50%, #3B82F6 100%);
}
```
...
- Use `colors.brandPrimary` (purple bold) for TRIVIAIOX branding
- Example: Welcome screens, major section headers

```javascript
console.log(colors.brandPrimary('🎉 TRIVIAIOX v4.2 Installer'));
```
...
// Success
console.log(colors.success('\n✓ All done! Your TRIVIAIOX project is ready.\n'));
```
  ...
  "triviaiox": {
    "color": {
      "primary": {
        "$type": "color",
        "$value": "#8B5CF6",
        "$description": "TRIVIAIOX primary brand color (ClickUp-inspired purple)"
      },
      "secondary": {
        "$type": "color",
        "$value": "#EC4899",
        "$description": "TRIVIAIOX secondary brand color (magenta accent)"
      },
      "success": {
        "$type": "color",
        "$value": "#10B981",
    ...
    "gradient": {
      "brand": {
        ...
        "$description": "TRIVIAIOX brand gradient (logo-inspired)"
      }
    }
  }
}
...
|---------|------|---------|--------|
| 2.1.0 | 2025-01-20 | Initial TRIVIAIOX Color Palette - Logo-inspired gradient + ClickUp purple | Uma (UX-Design Expert) |

---

## 🔗 Related Documents

- [TRIVIAIOX-LIVRO-DE-OURO-V2.1](./TRIVIAIOX-LIVRO-DE-OURO-V2.1-SUMMARY.md) - Complete TRIVIAIOX standards
