# TRIVIAIOX Framework - Livro de Ouro v4.2 (Complete)
...
**Mantido Por:** TRIVIAIOX Framework Team + Community
**Repositório Principal:** `Trivia-Growth/Triviaiox`

---

> **"Structure is Sacred. Tone is Flexible."**
> _— Fundamento filosófico do TRIVIAIOX_
...
- ✅ **npm Package Scoping** (@triviaiox/core, @triviaiox/squad-\*, @triviaiox/mcp-presets)

**Referências Legadas:**

- `TRIVIAIOX-LIVRO-DE-OURO.md` - Base v2.0.0 (Jan 2025)
- `TRIVIAIOX-LIVRO-DE-OURO-V2.1.md` - Delta parcial
- `TRIVIAIOX-LIVRO-DE-OURO-V2.1-SUMMARY.md` - Resumo de mudanças
...
```
┌─────────────────────────────────────────────────────────────────────────┐
│                     TRIVIAGROWTH ORGANIZATION                                 │
│                                                                         │
│   PUBLIC REPOSITORIES (3)                                               │
│   ═══════════════════════                                               │
│                                                                         │
│   ┌────────────────────────────────────────────────────────────────┐   │
│   │  Trivia-Growth/Triviaiox (Commons Clause)                         │   │
│   │  ─────────────────────────────────────                         │   │
...
│   ▼                          │                          ▼              │
│   ┌─────────────────────┐    │    ┌─────────────────────────────┐     │
│   │ Trivia-Growth/         │    │    │ Trivia-Growth/mcp-ecosystem    │     │
│   │ triviaiox-squads (MIT)   │    │    │ (Apache 2.0)                │     │
│   │ ─────────────────   │    │    │ ──────────────────────────  │     │
│   │ • ETL Squad         │    │    │ • Docker MCP Toolkit        │     │
│   │ • Creator Squad     │    │    │ • IDE Configurations        │     │
│   │ • MMOS Squad        │    │    │ • MCP Presets               │     │
│   │ npm: @triviaiox/squad-*  │    │    │ npm: @triviaiox/mcp-presets      │     │
│   └─────────────────────┘    │    └─────────────────────────────┘     │
│                              │                                         │
...
│                              │                                         │
│   ┌─────────────────────┐    │    ┌─────────────────────────────┐     │
│   │ Trivia-Growth/mmos     │    │    │ Trivia-Growth/certified-       │     │
...
| **TRIVIAIOX v4.2** | ✅ **Complete**          | ✅ **Clones (DNA Mental™)** ⭐ |

**Analogia:** Linux é open source, mas Red Hat Enterprise Linux adiciona suporte e otimizações. Ambos são Linux, mas o valor agregado varia. TRIVIAIOX funciona igual.
...
- 📋 **Layer 3: USAGE GUIDE** - Como usar TRIVIAIOX v4.2 no seu contexto
...
## Bem-vindo ao TRIVIAIOX v4.2 - Vamos Encontrar Seu Caminho
...
## Essay 1: Por Que TRIVIAIOX Existe
...
TRIVIAIOX fornece **orquestração estruturada**:
...
| **Pax**   | `triviaiox-master`   | Orchestrator | Framework orchestration |
...
@triviaiox-master     # Ativa Pax (Orchestrator)
...
|---------|----------|------------|---------|
| `@triviaiox/core` | npm public | - | Commons Clause |
| `@triviaiox/squad-etl` | npm public | @triviaiox/core | MIT |
| `@triviaiox/squad-creator` | npm public | @triviaiox/core | MIT |
| `@triviaiox/squad-mmos` | npm public | @triviaiox/core | MIT |
| `@triviaiox/mcp-presets` | npm public | - | Apache 2.0 |
...
$ npx @Trivia-Growth/triviaiox@latest init

# Existing project (Brownfield)
$ npx @Trivia-Growth/triviaiox migrate v2.0-to-v4.0.4
```
...
$ triviaiox agents list

# List available Squads
$ triviaiox squads list

# Create your first story
$ triviaiox stories create

# Execute a task
$ triviaiox task develop-story --story=1.1
```
...
```bash
# Clone all repos
mkdir -p ~/Workspaces/TRIVIAIOX && cd ~/Workspaces/TRIVIAIOX
gh repo clone Trivia-Growth/Triviaiox
gh repo clone Trivia-Growth/triviaiox-squads
gh repo clone Trivia-Growth/mcp-ecosystem

# Link for local development
cd triviaiox-core && npm install && npm link
cd ../triviaiox-squads && npm install && npm link @triviaiox/core

# VS Code workspace
code triviaiox-workspace.code-workspace
```
...
```bash
# Search for workers
$ triviaiox workers search "json parse"
...
# Get worker details
$ triviaiox workers info json-parser

# Use worker in task
$ triviaiox workers use json-parser --task my-task
```
...
| `brownfield-integration` | Add TRIVIAIOX to existing    | dev, architect    |
...
```bash
# Start workflow
$ triviaiox workflow greenfield-fullstack

# With parameters
$ triviaiox workflow brownfield-integration --target=./existing-project
```
...
├── .triviaiox-core/                        # Framework layer
│   ├── core/                          # Core module
...
**Mantido Por:** TRIVIAIOX Framework Team

---

_Este documento consolida TRIVIAIOX-LIVRO-DE-OURO.md (v2.0) + deltas v4.0.4 em um único documento completo._
