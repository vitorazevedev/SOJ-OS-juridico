...
**Version:** 2.1.0
**Date:** 2025-12-09
**Purpose:** Document differences between TRIVIAIOX open-source and TRIVIAIOX service implementations
...
TRIVIAIOX has two deployment contexts:
...
|------------|---------|------|----------|
| `Trivia-Growth/Triviaiox` | Commons Clause | Public | Core framework, 11 agents, Quality Gates |
| `Trivia-Growth/triviaiox-squads` | MIT | Public | ETL, Creator, MMOS-Mapper squads |
| `Trivia-Growth/mcp-ecosystem` | Apache 2.0 | Public | Docker MCP, IDE configs, MCP presets |
| `Trivia-Growth/mmos` | Proprietary + NDA | Private | MMOS Minds, DNA Mental |
| `Trivia-Growth/certified-partners` | Proprietary | Private | Premium squads, partner portal |

### npm Package Scoping

| Package | Registry | Availability |
|---------|----------|--------------|
| `@triviaiox/core` | npm public | Open-source |
| `@triviaiox/squad-etl` | npm public | Open-source |
| `@triviaiox/squad-creator` | npm public | Open-source |
| `@triviaiox/squad-mmos` | npm public | Open-source |
| `@triviaiox/mcp-presets` | npm public | Open-source |
...
│                                                                         │
│   Trivia-Growth/Triviaiox        Trivia-Growth/triviaiox-squads                   │
│   ┌─────────────────────┐     ┌─────────────────────┐                  │
...
│                                                                         │
│   Trivia-Growth/mmos             Trivia-Growth/certified-partners            │
│   ┌─────────────────────┐     ┌─────────────────────┐                  │
...
```yaml
**Template:**
- path: .triviaiox-core/templates/task-execution-report.md
  type: output
  version: 1.0
...
**Difference:**
- Open-source uses templates from `.triviaiox-core/templates/`
...
.triviaiox-core/checklists/{agent-id}-general-validation.md
```
...
- `.triviaiox-core/scripts/{agent-id}-specific/{script}.js`
...
**Scripts:**
- .triviaiox-core/scripts/dev-specific/test-runner.js:    # Only dev uses this
...
- Missing template → Use generic template from `.triviaiox-core/templates/`
...
- fallback: |
    ...
    1. Check .triviaiox-core/templates/ for generic version
...
**Agent Personas:**
- Defined in `.triviaiox-core/agents/{agent-id}.md`
...
- [ ] Update template paths (squads/ → .triviaiox-core/templates)
...
| **Templates** | .triviaiox-core/templates/ | squads/{squad}/ |
...
- [TRIVIAIOX-LIVRO-DE-OURO-V2.1-COMPLETE.md](./TRIVIAIOX-LIVRO-DE-OURO-V2.1-COMPLETE.md) - Complete v4.2 framework guide
