# TRIVIAIOX Tools - Integrations Directory

This directory contains tool integration definitions for TriviaGrowth Triviaiox agents. Tools are external capabilities that agents can discover and use to accomplish tasks.
...
ls -la .triviaiox-core/tools/cli/
ls -la .triviaiox-core/tools/local/
ls -la .triviaiox-core/tools/mcp/

# Test tool resolver
node .triviaiox-core/infrastructure/scripts/tool-resolver.js
```
