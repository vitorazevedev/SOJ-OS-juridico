...
Project Management tool adapters for TRIVIAIOX. Enables story synchronization with various PM tools.
...
PM tool is configured via `.triviaiox-pm-config.yaml` in the project root:
