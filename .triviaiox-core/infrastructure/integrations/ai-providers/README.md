...
Multi-provider AI integration for TRIVIAIOX. Supports Claude Code and Gemini CLI with automatic fallback and task-based routing.
...
Create `.triviaiox-ai-config.yaml` in project root:
