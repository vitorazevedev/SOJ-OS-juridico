...
> **Auto-generated by TRIVIAIOX** on {{GENERATED_DATE}}
...
```
{{PROJECT_NAME}}/
├── .triviaiox-core/                    # TRIVIAIOX configuration
...
|------|----------|---------|
| `.triviaiox-core/core-config.yaml` | Root | TRIVIAIOX configuration |
...
*Generated by TRIVIAIOX Documentation Integrity System*
