 ...
 *
 * Systematically tests all utilities in .triviaiox-core/scripts/ and classifies them
 * as WORKING, FIXABLE, or DEPRECATED based on their functional status.
 *
 * Usage: node .triviaiox-core/scripts/test-utilities.js
 */
...
async function countIntegrationReferences(utilityName) {
  ...
  const searchDirs = [
    '.triviaiox-core/agents',
    '.triviaiox-core/tasks',
    'squads',
  ];
