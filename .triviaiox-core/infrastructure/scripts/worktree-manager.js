 ...
 * @property {string} [worktreeDir='.triviaiox/worktrees'] - Directory for worktrees
 ...
 * @property {string} [mergeLogDir='.triviaiox/logs/merges'] - Directory for merge audit logs
 */
...
class WorktreeManager {
  ...
  constructor(projectRoot, options = {}) {
    ...
    this.worktreeDir = options.worktreeDir || '.triviaiox/worktrees';
    this.branchPrefix = options.branchPrefix || 'auto-claude/';
    this.staleDays = options.staleDays || 30;
    this.mergeLogDir = options.mergeLogDir || '.triviaiox/logs/merges';
    this.gitPath = 'git';
  }
