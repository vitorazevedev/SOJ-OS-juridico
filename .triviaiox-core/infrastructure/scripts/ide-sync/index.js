...
function loadConfig(projectRoot) {
  const configPath = path.join(projectRoot, '.triviaiox-core', 'core-config.yaml');
  ...
  const defaultConfig = {
    ...
    redirects: {
      ...
      'triviaiox-orchestrator': 'triviaiox-master',
...
function showHelp() {
  console.log(`
${colors.bright}IDE Sync${colors.reset} - Sync TRIVIAIOX agents to IDE command files
