 ...
 * Target: .claude/commands/TRIVIAIOX/agents/*.md
 */
...
function transform(agentData) {
  ...
  if (agentData.raw) {
    ...
    const syncFooter = `\n---\n*TRIVIAIOX Agent - Synced from .triviaiox-core/development/agents/${agentData.filename}*\n`;

    if (!agentData.raw.includes('Synced from .triviaiox-core/development/agents/')) {
