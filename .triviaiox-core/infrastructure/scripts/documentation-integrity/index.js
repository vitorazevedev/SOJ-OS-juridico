 ...
 *
 * Mode-aware project configuration system for TRIVIAIOX.
...
module.exports = {
  ...
  isTriviaioxCoreRepository: modeDetector.isTriviaioxCoreRepository,
  ...
  hasTriviaioxIntegration: gitignoreGenerator.hasTriviaioxIntegration,
