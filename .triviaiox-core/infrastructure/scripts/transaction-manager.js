/**
 * Transaction Manager for TriviaGrowth Triviaiox
...
class TransactionManager {
  constructor(options = {}) {
    ...
    this.transactionPath = path.join(this.rootPath, 'triviaiox-core', 'transactions');
    this.backupPath = path.join(this.rootPath, 'triviaiox-core', 'backups');
  ...
  async rollbackManifestUpdate(operation, results) {
    try {
      const manifestPath = path.join(this.rootPath, 'triviaiox-core', 'team-manifest.yaml');
