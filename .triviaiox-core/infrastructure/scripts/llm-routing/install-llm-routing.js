 ...
 *
 * @module llm-routing
 * @location .triviaiox-core/infrastructure/scripts/llm-routing/
 */
...
function getInstallationSummary(result) {
  ...
  if (result.success) {
    ...
    summary.push('');
    summary.push('Usage data saved to: ~/.triviaiox/usage-tracking/deepseek-usage.json');
    summary.push('');
  } else {
    summary.push('');
...
if (require.main === module) {
  console.log('\n🚀 TRIVIAIOX LLM Routing Installer\n');
