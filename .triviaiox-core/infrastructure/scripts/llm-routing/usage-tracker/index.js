 ...
 * @location .triviaiox-core/infrastructure/scripts/llm-routing/usage-tracker/
 */
...
const DATA_DIR = path.join(os.homedir(), '.triviaiox', 'usage-tracking');
...
║  Data File:    ~/.triviaiox/usage-tracking/deepseek-usage.json  ║
╠════════════════════════════════════════════════════════════╣
║  Endpoints:                                                ║
║    /health     - Health check                              ║
