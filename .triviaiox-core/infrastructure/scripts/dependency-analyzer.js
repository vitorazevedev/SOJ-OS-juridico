/**
 * Dependency Analyzer for TriviaGrowth Triviaiox
...
class DependencyAnalyzer {
  constructor(options = {}) {
    ...
    this.manifestPath = path.join(this.rootPath, 'triviaiox-core', 'team-manifest.yaml');
    
    // Component paths
    this.paths = {
      agents: path.join(this.rootPath, 'triviaiox-core', 'agents'),
      tasks: path.join(this.rootPath, 'triviaiox-core', 'tasks'),
      workflows: path.join(this.rootPath, 'triviaiox-core', 'workflows'),
    };
