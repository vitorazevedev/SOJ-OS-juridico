...
// Purpose: Collect tool usage data per session, store in .triviaiox/analytics/,
//          enforce data governance (sanitization, retention, schema).
//
// Usage:
//   node .triviaiox-core/infrastructure/scripts/collect-tool-usage.js [options]
//
// Options:
...
// --- Configuration ---
const ANALYTICS_DIR = path.resolve(process.cwd(), '.triviaiox', 'analytics');
...
function loadUsageData() {
  ...
  return {
    ...
    description: 'Tool usage tracking data for TRIVIAIOX token optimization (TOK-5)',
    sessions: []
  };
}
