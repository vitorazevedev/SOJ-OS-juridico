...
/**
 * Usage pattern analyzer for TriviaGrowth Triviaiox framework components
...
class UsageAnalytics {
  ...
  async findDirectReferences(component) {
    ...
    try {
      const searchPaths = [
        path.join(this.rootPath, 'triviaiox-core'),
  ...
  isExcludedDirectory(name) {
    const excludes = ['node_modules', '.git', '.triviaiox', 'dist', 'build', 'coverage'];
