 ...
 * - AC2: Generates `.triviaiox/gotchas.md` consolidated
...
const CONFIG = {
  ...
  outputJsonPath: '.triviaiox/gotchas.json',
  ...
  // Schema version
  schemaVersion: 'triviaiox-gotchas-v1',
};
...
*Generated by TRIVIAIOX Gotchas Documenter v${CONFIG.version}*
`;
  ...
  static showHelp() {
    console.log(`
Gotchas Documenter - TRIVIAIOX Memory Layer (Story 7.4)
