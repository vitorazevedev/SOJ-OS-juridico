...
/**
 * Framework structure analyzer for TriviaGrowth Triviaiox
 * Discovers and catalogs all framework components
 */
class FrameworkAnalyzer {
  constructor(options = {}) {
    this.rootPath = options.rootPath || process.cwd();
    this.triviaioxCoreDir = path.join(this.rootPath, 'triviaiox-core');
  ...
  async discoverAgents() {
    const agents = [];
    const agentsDir = path.join(this.triviaioxCoreDir, 'agents');
  ...
  async discoverTasks() {
    const tasks = [];
    const tasksDir = path.join(this.triviaioxCoreDir, 'tasks');
  ...
  async discoverWorkflows() {
    const workflows = [];
    const workflowsDir = path.join(this.triviaioxCoreDir, 'workflows');
  ...
  async discoverUtils() {
    const utils = [];
    const utilsDir = path.join(this.triviaioxCoreDir, 'utils');
  ...
  async discoverTemplates() {
    const templates = [];
    const templatesDir = path.join(this.triviaioxCoreDir, 'templates');
