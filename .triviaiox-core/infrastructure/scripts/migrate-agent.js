...
/**
 * TRIVIAIOX Agent Migration Script (V2 → V3)
...
// Paths
const AGENTS_DIR = '.triviaiox-core/development/agents';
const BACKUP_DIR = '.triviaiox/migration-backup';
const SCHEMAS_DIR = '.triviaiox-core/schemas';
...
function formatListOutput(agents) {
  ...
  lines.push('');
  lines.push('═══════════════════════════════════════════════════════════');
  lines.push('  TRIVIAIOX Agents - Migration Status');
  lines.push('═══════════════════════════════════════════════════════════');
  lines.push('');
