...
/**
 * Component search utility for TriviaGrowth Triviaiox framework
...
class ComponentSearch {
  ...
  async searchComponent(componentType, componentName) {
    ...
    const searchPaths = [
      path.join(this.rootPath, 'triviaiox-core', typeConfig.directory),
  ...
  async findRegistrationFile(componentType, componentName) {
    const possibleRegistrationFiles = [
      path.join(this.rootPath, 'triviaiox-core', 'registry.json'),
