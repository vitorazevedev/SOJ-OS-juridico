...
\`\`\``,
  ...
  async savePatterns(outputPath) {
    const defaultPath = path.join(this.rootPath, '.triviaiox', 'patterns.md');
...
`);
  ...
  // Find project root (look for package.json or .triviaiox-core)
