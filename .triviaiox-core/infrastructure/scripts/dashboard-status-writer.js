 ...
 *
 * Writes the current TRIVIAIOX agent status to .triviaiox/dashboard/status.json
...
const STATUS_DIR = '.triviaiox/dashboard';
 ...
 * Uses TRIVIAIOX_PROJECT_ROOT env var or cwd
 */
function getProjectRoot() {
  return process.env.TRIVIAIOX_PROJECT_ROOT || process.cwd();
}
