...
function generateReport() {
  ...
  let report = `# TRIVIAIOX Performance Report
...
`;
  ...
  report += '\n---\n\n*Auto-generated by TRIVIAIOX Performance Tracker (Story 6.1.2.6)*\n';
 ...
 */
async function savePerformanceData(filepath = '.triviaiox-core/performance-data.json') {
  const data = {
    ...performanceData,
 ...
 */
async function loadPerformanceData(filepath = '.triviaiox-core/performance-data.json') {
  try {
