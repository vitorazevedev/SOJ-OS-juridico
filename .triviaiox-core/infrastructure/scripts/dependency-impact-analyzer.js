...
/**
 * Dependency impact analyzer for TriviaGrowth Triviaiox framework
...
class DependencyImpactAnalyzer {
  ...
  extractDependenciesFromContent(content, filePath) {
    ...
    // Extract TRIVIAIOX-specific references
  ...
  categorizeDependency(dep, dependencies, filePath) {
    ...
    } else if (dep.includes('triviaiox-core/') || dep.includes('/triviaiox-core/')) {
