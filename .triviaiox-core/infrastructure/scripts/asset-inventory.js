...
/**
 * TRIVIAIOX Asset Inventory Generator
 * Story 2.1: Creates comprehensive inventory of all TRIVIAIOX assets
 *
 * Usage:
...
const ASSET_PATHS = {
  ...
  templates: '.triviaiox-core/product/templates',
  checklists: '.triviaiox-core/product/checklists',
  scripts: '.triviaiox-core/infrastructure/scripts',
  schemas: '.triviaiox-core/schemas',
...
function formatConsoleOutput(report, verbose = false) {
  ...
  lines.push('');
  lines.push('═══════════════════════════════════════════════════════════');
  lines.push('  TRIVIAIOX Asset Inventory');
...
Options:
  ...
  // Find project root (look for .triviaiox-core directory)
