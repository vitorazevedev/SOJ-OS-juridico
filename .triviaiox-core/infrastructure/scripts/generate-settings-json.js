...
const CORE_CONFIG_FILE = '.triviaiox-core/core-config.yaml';
 ...
 * - .triviaiox-core/core/** gets expanded one level deep
...
function expandProtectedPaths(protectedPaths, exceptions, projectRoot) {
  ...
  for (const globPath of protectedPaths) {
    if (globPath === '.triviaiox-core/core/**') {
      const { dirs, files } = expandOneLevel('.triviaiox-core/core', projectRoot);
...
function generatePermissions(boundary, projectRoot) {
  ...
  allow.push('Read(.triviaiox-core/**)');
