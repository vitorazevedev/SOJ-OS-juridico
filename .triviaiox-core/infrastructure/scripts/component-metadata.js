/**
 * Component Metadata Manager for TriviaGrowth Triviaiox
...
class ComponentMetadata {
  constructor(options = {}) {
    ...
    this.metadataPath = path.join(this.rootPath, 'triviaiox-core', 'metadata');

    // Initialize memory adapter if available
    this.memoryClient = MemoryAdapter ? new MemoryAdapter({
      persistencePath: path.join(this.rootPath, 'triviaiox-memory-layer-mvp', 'data'),
