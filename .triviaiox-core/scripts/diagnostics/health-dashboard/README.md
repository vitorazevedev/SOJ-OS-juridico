# TRIVIAIOX Health Dashboard

Visual dashboard for the TRIVIAIOX Health Check System. Displays real-time health status, domain scores, issues, and self-healing history.
...
- **Production**: Reads from `.triviaiox/reports/health-check-latest.json`
...
- [Health Check Core Module](../../.triviaiox-core/core/health-check/)
- [JSON Reporter](../../.triviaiox-core/core/health-check/reporters/json.js)

---

_Part of TRIVIAIOX-FULLSTACK - Story HCS-2 Phase 4_
