#!/usr/bin/env node
/**
 * TRIVIAIOX-Core Installation Diagnostic Tool
 *
 * Run this script to diagnose installation issues:
 *   node diagnose-installation.js
 *
 * Or directly from URL:
 *   npx https://raw.githubusercontent.com/Trivia-Growth/Triviaiox/main/tools/diagnose-installation.js
 */
...
console.log('');
console.log('╔══════════════════════════════════════════════════════════════════╗');
console.log('║          TRIVIAIOX-Core Installation Diagnostic Tool                  ║');
console.log('╚══════════════════════════════════════════════════════════════════╝');
console.log('');
...
const pkgInfo = exec('npm view triviaiox-core version 2>&1');
if (pkgInfo && !pkgInfo.includes('E404') && !pkgInfo.includes('error')) {
  console.log(`  ✓ triviaiox-core v${pkgInfo} is available on npm`);
} else {
  console.log('  ⚠️  Cannot verify triviaiox-core package availability');
...
console.log('  Testing: npx triviaiox-core@latest --version');
const npxTest = exec('npx triviaiox-core@latest --version 2>&1');
...
if (hasErrors) {
  ...
  console.log('');
  console.log('You can install TRIVIAIOX-Core with:');
  console.log('  npx triviaiox-core@latest');
  console.log('');
}
...
const summaryFile = path.join(os.tmpdir(), 'triviaiox-diagnostic-result.json');
