...
echo.
echo ========================================
echo    TRIVIAIOX-Core Quick Diagnostic (CMD)
echo ========================================
echo.
...
echo.
echo Checking triviaiox-core availability on npm...
npm view triviaiox-core version 2>nul
if %errorlevel% neq 0 (
    echo   ERROR: Cannot access npm registry!
    echo   Check your internet/firewall settings
) else (
    echo   triviaiox-core: Available
)

echo.
echo ========================================
echo    Testing npx triviaiox-core@latest
echo ========================================
echo.
echo Running: npx triviaiox-core@latest --version
echo (This may take a moment on first run...)
echo.
npx triviaiox-core@latest --version
if %errorlevel% neq 0 (
    echo.
    echo   ERROR: npx triviaiox-core failed!
    echo.
    echo Common fixes:
    ...
    echo   npx triviaiox-core@latest
)
