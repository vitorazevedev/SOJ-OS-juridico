...
## When to Use TRIVIAIOX for Brownfield
...
If you have just completed an MVP with TRIVIAIOX, and you want to continue with post-MVP, its easier to just talk to the PM and ask him to work with you to create a new epic to add into the PRD, shard out the epic, update any architecture documents with the architect, and just go from there.
