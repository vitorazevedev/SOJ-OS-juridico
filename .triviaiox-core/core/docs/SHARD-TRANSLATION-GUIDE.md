...
TriviaGrowth Triviaiox now automatically translates Portuguese documentation into English filenames when sharding documents. This ensures consistency across all projects and compatibility with hardcoded English filenames in configuration files.
...
**See full dictionary:** `.triviaiox-core/tasks/shard-doc.md` (Section 3)
...
**Configuration:** `.triviaiox-core/core-config.yaml`
...
```bash
# Check for issues
node .triviaiox-core/scripts/validate-filenames.js

# Auto-fix issues (renames files)
node .triviaiox-core/scripts/validate-filenames.js --fix
```
...
Edit `.triviaiox-core/tasks/shard-doc.md`, Section 3:
...
**Solution:**
1. Check you're using the updated `.triviaiox-core/tasks/shard-doc.md`
2. Run validator to confirm: `node .triviaiox-core/scripts/validate-filenames.js`
...
**Manual fix:**
Edit `.triviaiox-core/core-config.yaml` to add more fallbacks.
...
```javascript
// .triviaiox-core/scripts/validate-filenames.js
...
A: Edit `.triviaiox-core/tasks/shard-doc.md`, Section 3, and add to the YAML dictionary.
...
2. Run the validator: `node .triviaiox-core/scripts/validate-filenames.js`
3. Review `.triviaiox-core/tasks/shard-doc.md` for translation rules
...
**Feature Version:** TRIVIAIOX v4.x
