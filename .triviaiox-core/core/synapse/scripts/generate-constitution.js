 ...
 *
 * Reads .triviaiox-core/constitution.md and generates .synapse/constitution
 * in KEY=VALUE format for the SYNAPSE Context Engine L0 layer.
 *
 * Usage: node .triviaiox-core/core/synapse/scripts/generate-constitution.js
 *
...
function generateConstitution(articles) {
  const lines = [
    ...
    '# Auto-generated from .triviaiox-core/constitution.md',
...
function main(options = {}) {
  ...
  const constitutionPath = options.constitutionPath || path.join(projectRoot, '.triviaiox-core', 'constitution.md');
