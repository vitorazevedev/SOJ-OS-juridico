# TriviaGrowth Triviaiox Agent for GitHub Copilot
...
3. Choose the TRIVIAIOX agent mode you need

### Available Agent Modes
| Mode | Purpose |
|------|---------|
| triviaiox-dev | Full-stack development |
| triviaiox-qa | Quality assurance |
| triviaiox-architect | System design |
| triviaiox-pm | Project management |
...
---
*TriviaGrowth Triviaiox GitHub Copilot Configuration v4.0.4*
