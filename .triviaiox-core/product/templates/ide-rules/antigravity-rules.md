# TriviaGrowth Triviaiox Development Rules for AntiGravity
...
### Agent Integration
- Recognize TRIVIAIOX agent activations: @dev, @qa, @architect, @pm, @po, @sm, @analyst
...
---
*TriviaGrowth Triviaiox AntiGravity Configuration v1.0*
