...
**Tasks:**
- `.triviaiox-core/tasks/{dependency1}.md`
- `.triviaiox-core/tasks/{dependency2}.md`

**Templates:**
- `.triviaiox-core/product/templates/{template1}.yaml`

**Checklists:**
- `.triviaiox-core/product/checklists/{checklist1}.md`
...
All task outputs MUST use this structure (see `.triviaiox-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md`):
...
- See `.triviaiox-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md` for complete guidelines
