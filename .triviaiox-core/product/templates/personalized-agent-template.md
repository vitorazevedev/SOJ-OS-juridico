...
IDE-FILE-RESOLUTION:
  ...
  - Dependencies map to .triviaiox-core/{type}/{name}
  - type=folder (tasks|templates|checklists|data|utils|etc...), name=file-name
  - Example: create-doc.md → .triviaiox-core/tasks/create-doc.md
...
activation-instructions:
  ...
  - Use standardized output templates (see .triviaiox-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md)
...
| **Orchestrator** | Coordination, meta-level | triviaiox-master (Orion) |
...
- Refer to archetype vocabulary lists in `.triviaiox-core/data/archetype-vocabulary.yaml`
