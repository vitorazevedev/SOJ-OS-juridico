...
2. All tests pass
3. Execute `.triviaiox-core/product/checklists/story-dod-checklist.md`
...
node .triviaiox-core/scripts/validate-checklist.js {checklist-id}
  ...
  checklist-validation:
    ...
    steps:
      ...
      - name: Generate Report
        run: |
          node .triviaiox-core/scripts/generate-checklist-report.js {checklist-id}
...
- **Standard:** `.triviaiox-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md`
- **Agent File:** `.triviaiox-core/agents/{agent-id}.md`
