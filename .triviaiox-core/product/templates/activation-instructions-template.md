...
This template defines the canonical activation-instructions format for TRIVIAIOX agents after GreetingBuilder integration (Story 6.1.2.5).
...
activation-instructions:
  ...
  - STEP 3: Build intelligent greeting using .triviaiox-core/development/scripts/greeting-builder.js
...
```yaml
- STEP 2.5: Load project status using .triviaiox-core/infrastructure/scripts/project-status-loader.js
- STEP 2.6: Load session context using .triviaiox-core/scripts/session-context-loader.js
...
- **GreetingBuilder**: `.triviaiox-core/development/scripts/greeting-builder.js`
- **Context Detector**: `.triviaiox-core/core/session/context-detector.js`
- **Git Config Detector**: `.triviaiox-core/infrastructure/scripts/git-config-detector.js`
- **Workflow Navigator**: `.triviaiox-core/development/scripts/workflow-navigator.js`
- **Project Status Loader**: `.triviaiox-core/infrastructure/scripts/project-status-loader.js`
- **Workflow Patterns**: `.triviaiox-core/data/workflow-patterns.yaml`
...
*Template maintained by TRIVIAIOX Framework Team*
