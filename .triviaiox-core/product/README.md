...
```javascript
const templatePath = '.triviaiox-core/product/templates/story-tmpl.yaml';
const checklistPath = '.triviaiox-core/product/checklists/story-dod-checklist.md';
```
...
---
*TriviaGrowth Triviaiox v4 - Product Module*
