# Guia do Usuário TriviaGrowth Triviaiox

## Visão Geral

O TriviaGrowth Triviaiox é um framework de desenvolvimento full stack orientado por agentes de IA que implementa uma metodologia ágil única. Este guia explica como usar o TriviaGrowth Triviaiox de forma eficaz através de suas duas fases principais: **Planejamento** e **Desenvolvimento**.
...
### Instalando TRIVIAIOX-FullStack

O TRIVIAIOX-FullStack oferece instalação simplificada através de um instalador interativo completo.
...
npx triviaiox-core@latest install

# OU usando NPM direto (produção - quando disponível)
npx @triviaiox/fullstack install
```

**O que acontece durante a instalação**:

```
🚀 TRIVIAIOX-FullStack Installation Wizard
...
📦 Select Squads to Install:
  ...
  ◯ triviaiox-infrastructure-devops (DevOps utilities)
...
✓ Installing .triviaiox-core/ framework...
✓ Installing squads...
...
Se você está contribuindo para o TRIVIAIOX-FullStack em si:

```bash
# Clone o repositório
git clone https://github.com/Trivia-Growth/Triviaiox
cd triviaiox-core
...
```
your-project/
├── .triviaiox-core/                    # ✅ Framework core instalado
...
Se você já tem TRIVIAIOX instalado e quer fazer upgrade:

```bash
# Upgrade automático (RC.9+)
npx triviaiox-core@latest install --force-upgrade

# OU interativo (todos os RCs)
npx triviaiox-core@latest install
# → Menu aparece:
#   1. Keep current version (v1.0.0-rc.8)
#   2. Upgrade TRIVIAIOX core (v1.0.0-rc.8 → v1.0.0-rc.10)
...
npm view triviaiox-core@latest version
# Output: 1.0.0-rc.10

# Ver opções de instalação e comandos disponíveis
npx triviaiox-core@latest --help
...
# Ajuda do instalador
npx triviaiox-core@latest install --help
```
...
O futuro comando `triviaiox init` permitirá escolher explicitamente entre dois modos:

#### Framework Development Mode
- Para desenvolvedores contribuindo ao TRIVIAIOX-FullStack
- `.triviaiox-core/` é código fonte (commitado)
- Mudanças afetam o framework
- Quality gates testam integridade do framework

#### Project Development Mode
- Para desenvolvedores usando TRIVIAIOX em seus projetos
- `.triviaiox-core/` é dependência (gitignored)
...
# Cria .triviaiox-installation-config.yaml
...
npx triviaiox-core@1.0.0-rc.10 install --force-upgrade
```
...
O TriviaGrowth Triviaiox usa uma abordagem de duas fases que separa planejamento estratégico de implementação tática:
...
O agente **qa** do TriviaGrowth Triviaiox inclui capacidades avançadas de arquitetura de testes:
...
2. **Recursos especiais**:
   - Reconhecimento automático de comandos TRIVIAIOX
   - Integração com workflows e tasks
   - Rastreamento automático de checkboxes

## Sistema de Preferências Técnicas

O TriviaGrowth Triviaiox permite configurar preferências técnicas que influenciam decisões dos agentes:
...
O TRIVIAIOX-FullStack impõe integridade de repositório através de um agente centralizado de DevOps.
...
```bash
# No repositório triviaiox-core
@github-devops
*detect-repo
# Output:
# Repository: github.com/Trivia-Growth/Triviaiox
# Mode: framework-development
# Quality Gates: Testes do framework TRIVIAIOX
```
...
O TRIVIAIOX-FullStack oferece três modos de desenvolvimento para acomodar diferentes níveis de habilidade e restrições de tempo.
...
Ao integrar TriviaGrowth Triviaiox em projetos existentes:
...
O TriviaGrowth Triviaiox inclui meta-agentes para orquestração:

### triviaiox-master

O **triviaiox-master** é o agente de orquestração principal:
...
### triviaiox-orchestrator

O **triviaiox-orchestrator** gerencia fluxos de trabalho:
...
O **triviaiox-developer** é o meta-agente para o próprio TRIVIAIOX:
...
[triviaiox-developer guiará você na criação de um novo agente]
```
...
O TriviaGrowth Triviaiox suporta squads para domínios específicos:
...
- **triviaiox-infrastructure-devops** - Utilities de DevOps e infraestrutura
...
#   ◉ hybrid-ops
#   ◯ expansion-creator
#   ◯ triviaiox-infrastructure-devops
#   ◯ meeting-notes
```
...
Use o **triviaiox-developer** para criar agentes customizados:
...
Adicione templates próprios em `triviaiox-core/templates/`:
...
- [ ] IDE configurado com regras TRIVIAIOX
...
- [Arquitetura do TRIVIAIOX](../docs/architecture.md)
- [Guia de Squads](../docs/Squads.md)
- [Trabalhando em Brownfield](./working-in-the-brownfield.md)

### Suporte
- [GitHub Issues](https://github.com/Trivia-Growth/Triviaiox/issues)
...
*TriviaGrowth Triviaiox User Guide v2.0*
