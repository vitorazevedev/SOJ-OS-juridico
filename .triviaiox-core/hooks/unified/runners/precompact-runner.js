 ...
 * - triviaiox-core: Hook runner (this file) + pro detection
 * - triviaiox-pro: Digest extraction logic (memory/session-digest/)
 *
 * @module .triviaiox-core/hooks/unified/runners/precompact-runner
 * @see Story MIS-3 - Session Digest (PreCompact Hook)
 * @see Story PRO-5 - triviaiox-pro Repository Bootstrap
 */
