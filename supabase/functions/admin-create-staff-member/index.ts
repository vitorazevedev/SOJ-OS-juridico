          ...
          <div style="background:#0b1220;padding:40px 16px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif">
            <div style="max-width:480px;margin:0 auto;background:#101a2c;border:1px solid #1e2a3f;border-radius:16px;overflow:hidden">
              ...
              <div style="padding:20px 32px 0 32px">
                ...
                <p style="margin:0 0 18px;font-size:15px;line-height:24px;color:#cbd5e1">Você foi cadastrado(a) como ${jobTitle || "membro"} da equipe Ponderum. Clique no link abaixo para definir sua senha de acesso.</p>
    ...
    if (sendEmail) {
      ...
      if (resendKey) {
        const [passwordEmailOk] = await Promise.all([
          sendOnboardingEmail(email, name, jobTitle, actionLink, resendKey),
