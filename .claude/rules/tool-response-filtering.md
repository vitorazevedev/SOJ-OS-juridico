---
paths:
  - .triviaiox-core/data/tool-registry.yaml
  - .mcp.json
---
...
configuration defined in `.triviaiox-core/data/tool-registry.yaml` for the tool that
...
`.triviaiox-core/utils/filters/` are available for batch post-processing of
