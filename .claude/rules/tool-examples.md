...
- **Pre-commit:** `wsl bash -c 'cd /mnt/c/.../triviaiox-core && ~/.local/bin/coderabbit --prompt-only -t uncommitted'`
- **Pre-PR:** `wsl bash -c 'cd /mnt/c/.../triviaiox-core && ~/.local/bin/coderabbit --prompt-only --base main'`
...
Full examples registry: `.triviaiox-core/data/mcp-tool-examples.yaml`
Tool registry: `.triviaiox-core/data/tool-registry.yaml`
