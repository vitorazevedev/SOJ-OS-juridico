...
- `.claude/CLAUDE.md`
- `.claude/rules/*.md`
- `.triviaiox-core/development/agents/*.md`
...
O installer (`ide-config-generator.js`) usa `HOOK_EVENT_MAP` para registrar automaticamente cada hook no evento correto durante `npx triviaiox-core install`.
