...
IDE-FILE-RESOLUTION:
  ...
  - Example: audit-codebase.md → .triviaiox-core/development/tasks/audit-codebase.md
...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .triviaiox-core/development/scripts/unified-activation-pipeline.js ux-design-expert
...
agent:
  ...
  customization: |
    ...
    Phase 1 Commands:
    *research        → Read(".triviaiox-core/development/tasks/ux-user-research.md")
    *wireframe       → Read(".triviaiox-core/development/tasks/ux-create-wireframe.md")
    *generate-ui-prompt → Read(".triviaiox-core/development/tasks/generate-ai-frontend-prompt.md")
    *create-front-end-spec → Read(".triviaiox-core/development/tasks/create-doc.md") + template

    Phase 2 Commands:
    *audit           → Read(".triviaiox-core/development/tasks/audit-codebase.md")
    *consolidate     → Read(".triviaiox-core/development/tasks/consolidate-patterns.md")
    *shock-report    → Read(".triviaiox-core/development/tasks/generate-shock-report.md")

    Phase 3 Commands:
    *tokenize        → Read(".triviaiox-core/development/tasks/extract-tokens.md")
    *setup           → Read(".triviaiox-core/development/tasks/setup-design-system.md")
    *migrate         → Read(".triviaiox-core/development/tasks/generate-migration-strategy.md")
    *upgrade-tailwind → Read(".triviaiox-core/development/tasks/tailwind-upgrade.md")
    *audit-tailwind-config → Read(".triviaiox-core/development/tasks/audit-tailwind-config.md")
    *export-dtcg     → Read(".triviaiox-core/development/tasks/export-design-tokens-dtcg.md")
    *bootstrap-shadcn → Read(".triviaiox-core/development/tasks/bootstrap-shadcn-library.md")

    Phase 4 Commands:
    *build           → Read(".triviaiox-core/development/tasks/build-component.md")
    *compose         → Read(".triviaiox-core/development/tasks/compose-molecule.md")
    *extend          → Read(".triviaiox-core/development/tasks/extend-pattern.md")

    Phase 5 Commands:
    *document        → Read(".triviaiox-core/development/tasks/generate-documentation.md")
    *a11y-check      → Read(".triviaiox-core/development/checklists/accessibility-wcag-checklist.md")
    *calculate-roi   → Read(".triviaiox-core/development/tasks/calculate-roi.md")

    Universal Commands:
    *scan            → Read(".triviaiox-core/development/tasks/ux-ds-scan-artifact.md")
    *integrate       → Read(".triviaiox-core/development/tasks/integrate-Squad.md")
...
---
---
*TRIVIAIOX Agent - Synced from .triviaiox-core/development/agents/ux-design-expert.md*
